...
The caret package (short for Classification And REgression Training) is a set of functions that attempt to streamline the process for creating predictive models. T
...
This book is a great resource to learn statistics with the R programming language.  

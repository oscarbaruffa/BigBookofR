...
[Okan Bulut](https://twitter.com/drokanbulut), [Christopher Desjardins](https://github.com/cddesja)
...
# Data Science
## R for Data Science 
[Hadley Wickham](https://twitter.com/hadleywickham) [Garret Grolemund](https://twitter.com/StatGarrett)
...
Learn how to build your own data visualisation packages, improve shiny with 
...
R: The tutorial is in R. For those without experience programming in R we have a [high-level version](https://cryptocurrencyresearch.org/high-level) to help you learn before attempting the full version. Scroll down for a [breakdown of the individual sections](https://cryptocurrencyresearch.org/index.html#sections) for an overview of what you will learn throughout.

Tidyverse: You will get more familiar with tools from the tidyverse, including [dplyr](https://dplyr.tidyverse.org/), [ggplot2](https://ggplot2.tidyverse.org/), [tibble](https://tibble.tidyverse.org/), and [purrr](https://purrr.tidyverse.org/). These tools provide an excellent complete ecosystem to do data science in R.

Machine Learning: You will learn to [create machine learning models](https://cryptocurrencyresearch.org/predictive-modeling.html) and how to fairly [assess their performance](https://cryptocurrencyresearch.org/model-validation-plan.html).
...
[Tom Hengl](https://opengeohub.org/people/tom-hengl) and [Robert A. MacMillan](https://opengeohub.org/people/bob-macmillan)
...
learn how to find your way around R and RStudio,
see how much you can do in just a few lines of code,
start doing some basic data exploration, and
get some ideas and sample code for using R in analyzing election results.
...
by Daniel Borcard, François Gillet, [Pierre Legendre](http://adn.biol.umontreal.ca/~numericalecology/indexEn.html) 
...
## R packages
[Hadley Wickham](https://twitter.com/hadleywickham), [Jenny Bryan](https://twitter.com/JennyBryan)
...
## HTTP testing in R
[Scott Chamberlain](https://twitter.com/sckottie), [Maëlle Salmon](https://twitter.com/ma_salmon)
...
The book is free online.
(Ignore the message redirecting you to the 2nd edition, this is the latest edition)
...
[Francesca Mancini](https://twitter.com/frances_mancini) and
...
The full-color book ($68) is available via Amazon: https://www.amazon.com/dp/B08DBYPRD2 
and online (free) at: http://causact.com.  Video supplements for all chapters [available on YouTube.](https://www.youtube.com/playlist?list=PLassxuIVwGLPy-mtohX-NXrjD8fc9FBOc)
...
[Chester Ismay](https://twitter.com/old_man_chester) and [Albert Kim](https://twitter.com/rudeboybert) 
...
[Mine Çetinkaya-Rundel](https://twitter.com/minebocek), [Johanna Hardin](@jo_hardin47)

We hope readers will take away three ideas from this book in addition to forming a foundation of statistical thinking and methods.

1. Statistics is an applied field with a wide range of practical applications.
1. You don’t have to be a math guru to learn from interesting, real data.
1. Data are messy, and statistical tools are imperfect. However, when you understand the strengths and weaknesses of these tools, you can use them to learn interesting things about the~world.
...
Second edition supporting the [forecast](https://pkg.robjhyndman.com/forecast/) package:
https://otexts.com/fpp2/

Third edition supporting the [fable](https://fable.tidyverts.org/) package:
...
[Desirée De Leon](https://desiree.rbind.io/) and

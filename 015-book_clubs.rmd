...
R book clubs are usually a group of people who follow along together in working though a the same book, with some sort of period check-in (often weekly, often via video) discussing the text, exercises and solutions. 

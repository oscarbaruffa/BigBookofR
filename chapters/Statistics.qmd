...
Link: [https://solomon.quarto.pub/alda/](https://solomon.quarto.pub/alda/)
...
Covers the auhors three favorite research topics – capture-recapture, hidden Markov models and Bayesian statistics – let’s enjoy this great cocktail together

Link: [https://oliviergimenez.github.io/banana-book/index.html](https://oliviergimenez.github.io/banana-book/index.html)
...
Link: [https://solomon.quarto.pub/dbda2/](https://solomon.quarto.pub/dbda2/)
...
Link: [https://www.kellerbiostat.com/introregression/](https://www.kellerbiostat.com/introregression/)
...
## Model to Meaning: How to Interpret Statistical Models
With marginaleffects for R and Python

- Vincent Arel-Bundock

Code and documentation for the open source marginaleffects package.
...
Physical copy available: [https://amzn.to/42MbdeP](https://amzn.to/42MbdeP)
...
Link: [https://probstatsdata.com/](https://probstatsdata.com/)
...
Link: [https://solomon.quarto.pub/immcpa2/](https://solomon.quarto.pub/immcpa2/)
...
## Statistical Rethinking 2 with brms and the tidyverse

- A Solomon Kurz

This ebook is based on the second edition of Richard McElreath’s (2020) text, Statistical rethinking: A Bayesian course with examples in R and Stan

Link: [https://solomon.quarto.pub/sr2/](https://solomon.quarto.pub/sr2/)
...
Link: [https://solomon.quarto.pub/sr/](https://solomon.quarto.pub/sr/)

## Statistical Rethinking with rstan and the tidyverse

- A Solomon Kurz

This book is based on the second edition of Richard McElreath’s (2020) text, Statistical rethinking: A Bayesian course with examples in R and Stan. My contributions show how to fit the models he covered with rstan.

Link: [https://solomon.quarto.pub/sr2rstan/](https://solomon.quarto.pub/sr2rstan/)

...
output: 
  bookdown::gitbook:
    includes:
      in_header: [google-analytics.html, plausible-analytics.html, social.html]
    config:
...
I've been collecting these for about 2 years now, totaling about 150 books, and thought I'd share it with you :).
...
[Ezekiel Adebayo Ogundepo](https://twitter.com/gbganalyst)

[Shamsuddeen Hassan Muhammad](https://twitter.com/Shmuhammadd)

[Eric Leung](https://twitter.com/erictleung)
...
If you want to stay in the loop on other data-related products I create, sign up to my [newsletter](https://oscarbaruffa.com/newsletter/).
